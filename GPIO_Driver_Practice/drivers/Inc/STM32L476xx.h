...
#define ROM_BASE_ADDR		0x1FFF 0000UL
#define SRAM1_BASE_ADDR		0x2000 0000UL
#define SRAM2_BASE_ADDR		0x1000 0000UL

// Bus Domain Base Address Macros
#define PERIPH_BASE_ADDR	0x4000 0000UL
#define APB1_BASE_ADDR		(PERIPH_BASE_ADDR + 0x0000 0000UL)
#define APB2_BASE_ADDR		(PERIPH_BASE_ADDR + 0x0001 0000UL)
#define AHB1_BASE_ADDR		(PERIPH_BASE_ADDR + 0x0002 0000UL)
#define AHB2_BASE_ADDR		(PERIPH_BASE_ADDR + 0x0800 0000UL)
...
// AHB1 Peripherals
#define RCC_BASE_ADDR		(AHB1_BASE_ADDR + 0x0000 1000UL)

// AHB2 Peripherals
#define GPIO_BASE_ADDR		(AHB2_BASE_ADDR + 0x0000 0000UL)
#define GPIOA_BASE_ADDR		(GPIO_BASE_ADDR + 0x0000 0000UL)
#define GPIOB_BASE_ADDR		(GPIO_BASE_ADDR + 0x0000 0400UL)
#define GPIOC_BASE_ADDR		(GPIO_BASE_ADDR + 0x0000 0800UL)
#define GPIOD_BASE_ADDR		(GPIO_BASE_ADDR + 0x0000 0C00UL)
#define GPIOE_BASE_ADDR		(GPIO_BASE_ADDR + 0x0000 1000UL)
#define GPIOF_BASE_ADDR		(GPIO_BASE_ADDR + 0x0000 1400UL)
#define GPIOG_BASE_ADDR		(GPIO_BASE_ADDR + 0x0000 1800UL)
#define GPIOH_BASE_ADDR		(GPIO_BASE_ADDR + 0x0000 1C00UL)

// APB1 Peripherals
#define I2C_BASE_ADDR		(APB1_BASE_ADDR + 0x0000 5400UL)
#define I2C1_BASE_ADDR		(I2C_BASE_ADDR + 0x0000 0000UL)
#define I2C2_BASE_ADDR		(I2C_BASE_ADDR + 0x0000 0400UL)
#define I2C3_BASE_ADDR		(I2C_BASE_ADDR + 0x0000 0800UL)

#define SPI2_BASE_ADDR		(APB1_BASE_ADDR + 0x0000 3800UL)
#define SPI3_BASE_ADDR		(APB1_BASE_ADDR + 0x0000 3C00UL)

#define USART2_BASE_ADDR	(APB1_BASE_ADDR + 0x0000 4400UL)
#define USART3_BASE_ADDR	(APB1_BASE_ADDR + 0x0000 4800UL)
#define UART4_BASE_ADDR		(APB1_BASE_ADDR + 0x0000 4C00UL)
#define UART5_BASE_ADDR		(APB1_BASE_ADDR + 0x0000 5000UL)

// APB2 Peripherals
#define EXTI_BASE_ADDR		(APB2_BASE_ADDR + 0x0000 0400UL)
#define SPI1_BASE_ADDR		(APB2_BASE_ADDR + 0x0000 3000UL)
#define SYSCFG_BASE_ADDR	(APB2_BASE_ADDR + 0x0000 0000UL)
#define USART1_BASE_ADDR	(APB2_BASE_ADDR + 0x0000 3800UL)
